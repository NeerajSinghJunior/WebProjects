...
<head>
	...
	<!-- Fav Icon  -->
	<link rel="shortcut icon" href="{{$settings->fav_icon}}">
	<!-- Site Title  -->
		...
		<div class="navbar navbar-expand-lg is-transparent" id="mainnav">
			<nav class="container">
				...
				<a class="navbar-brand" href="./">
					<img class="logo logo-dark" alt="logo" src="{{asset('img/logo.png')}}" srcset="{{asset('img/logo.png')}} 2x" width="100px" height="50px">
					<img class="logo logo-light" alt="logo" src="{{asset('img/logo.png')}}" srcset="{{asset('img/logo.png')}} 2x">
				</a>
