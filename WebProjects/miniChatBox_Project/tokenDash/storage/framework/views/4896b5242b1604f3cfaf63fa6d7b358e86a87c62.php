...
<body class="fix-header fix-sidebar">
    ...
    <div class="log-right">
        <div class="box-inner">
            <img src="<?php echo e(asset($settings->site_logo)); ?>" class="img-responsive"/>
            ...
            <div class="input-field">
                <input type="password" type="password"  value="<?php echo e(old('password')); ?>"  name="password" class="form-control" placeholder="Password">
            </div>  

                        <?php if($settings->google2fa_on): ?>
                                <div class="input-field">
                                    <label>Google Authenticator Code</label>
                                    <input type="password"   value="<?php echo e(old('otp')); ?>" name="otp"  placeholder="OTP">
                                </div>
                                <?php endif; ?>
