...
<head>
	...
	<meta name="description" content="Token Crypto is a modern and elegant landing page, created for Token Offering Agencies and digital crypto currency investment website.">
	<!-- Fav Icon  -->
	<link rel="shortcut icon" href="<?php echo e($settings->fav_icon); ?>">
	<!-- Site Title  -->
		...
		<div class="navbar navbar-expand-lg is-transparent" id="mainnav">
			<nav class="container">
				...
				<a class="navbar-brand" href="./">
					<img class="logo logo-dark" alt="logo" src="<?php echo e(asset('img/logo.png')); ?>" srcset="<?php echo e(asset('img/logo.png')); ?> 2x" width="100px" height="50px">
					<img class="logo logo-light" alt="logo" src="<?php echo e(asset('img/logo.png')); ?>" srcset="<?php echo e(asset('img/logo.png')); ?> 2x">
				</a>
				...
				<div class="collapse navbar-collapse justify-content-end" id="navbarToggle">
					<ul class="navbar-nav">
						<li class="nav-item"><a class="nav-link menu-link" href="#intro">What is Token Offering<span class="sr-only">(current)</span></a></li>
					...
					<div class="row align-items-center mobile-center">
						<div class="col-lg-6 col-md-12 order-lg-first">
							<div class="header-txt">
								<h1>Start your Token Offering</h1>
								<p class="lead color-secondary">System for running a full fledged Token Offerings</p>
								<ul class="btns">
									<li><a href="/register" class="btn">Sign up to Join</a></li>
									<?php if($settings->white_paper): ?>
									<li><a target="_blank" href="<?php echo e($settings->white_paper); ?>" class="btn btn-alt">White Paper</a></li>
									<?php endif; ?>
								</ul>
								<ul class="social">
						...
						<div class="col-lg-5 offset-lg-1 col-md-12 order-first">
							<div class="countdown-box countdown-header text-center">
								...
								<div class="token-countdown d-flex align-content-stretch" data-date="<?php echo e($settings->date_to_be_launched); ?>"></div>
								...
								<a href="/register" class="btn btn-alt btn-sm">Purchase TOKEN NOW</a>
								<ul class="icon-list">
