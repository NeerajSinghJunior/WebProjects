<?php $settings = DB::table('admins')->select('site_title', 'site_logo', 'fav_ico')->first(); ?>  <?php $__env->startSection('htmlheader_title'); ?> Register <?php $__env->stopSection(); ?> <?php $__env->startSection('content'); ?>
...
<body class="hold-transition register-page">
    <div id="app" v-cloak>
        ...
        <div class="register-box">
            ...
            <div class="register-box-body row">
                <div class="left col-md-6 col-sm-6 col-xs-12">
                    ...
                    <p>You'll be able to participate in the Initial Coin offering only if you have an account.</p>

                   <!--  <a href="<?php echo e(url('/home')); ?>"><img class="login-logo" src="<?php echo e($settings->site_logo); ?>"></a>
                    <h5>Register</h5>
                    <p>Please enter the details to register and be a part of great community.</p>
                    <br><br>
                    <p>Already have an account?</p>
                    <a class="link" href="<?php echo e(url('/login')); ?>">Login to your Account</a> -->
                </div>
                <div class="right col-md-6 col-sm-6 col-xs-12">
                <!-- <register-form><div style="margin-left: 15px;" name="recaptcha" class="g-recaptcha" data-sitekey="<?php echo e($captcha->captcha_key); ?>"></register-form> -->
                <form method="post">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group has-feedback ">
                        <input type="text" placeholder="Full Name" name="name" value="<?php echo e(old('name')); ?>" autofocus="autofocus" class="form-control"> <span class="glyphicon glyphicon-user form-control-feedback"></span>
                        <!---->
                    </div>
                    <div class="form-group has-feedback">
                        <input type="email" placeholder="Email" name="email" value="<?php echo e(old('email')); ?>" class="form-control"> <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
                        <!---->
                    </div>
                       <div class="form-group has-feedback">
                 ...
                 <div class="form-group has-feedback">
                    ...
                    <div class="form-group has-feedback ">
                        <input type="tel" placeholder="Phone" name="phone" value="<?php echo e(old('phone')); ?>"autofocus="autofocus" class="form-control"> <span class="glyphicon glyphicon-phone form-control-feedback"></span>
                        <!---->
                    </div>
                    <div class="form-group has-feedback">
                    ...
                    <div class="form-group has-feedback">
                        <input type="hidden" value="<?php echo e(request()->ref); ?>" name="referred_by" class="form-control">
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div>
                        ...
                        <div class="col-md-12 captcha-box">
                            <div name="recaptcha" class="g-recaptcha recaptcha-otr " data-sitekey="<?php echo e($captcha->captcha_key); ?>">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <button type="submit" class="btn btn-primary btn-block">Register</button>
                            <a href="<?php echo e(route('oauth_social','google')); ?>" class="btn btn-primary btn-block btn-social btn-google">Sign Up With Google</a>
                        </div>
                        <div class="col-md-12">
                            <p style="margin-top: 15px;"> <a class="link pull-right" href="<?php echo e(url('/login')); ?>">Already have account?</a></p> 
                        </div>
                </form>
                </div>
                </div>
        ...
        <?php echo $__env->make('adminlte::layouts.partials.scripts_auth', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?> <?php echo $__env->make('adminlte::auth.terms', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
</body>
